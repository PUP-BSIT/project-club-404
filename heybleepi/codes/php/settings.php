...
<html lang="en">
  ...
  <body>
    ...
    <!-- Changes Saved Modal -->
    <div id="small_modal_container" class="small-modal hidden">
      <p class="text-info" id="text_info">Changes Saved!</p>
    </div>
    <!-- End of Changes Saved Modal -->
  ...
  <div id="privacy_settings_container" 
      ...
      <form required>
        ...
        <button 
          ...
          <?php if (isset($_SESSION['oauth_provider'])) echo 'readonly style="background-color: #8f9585; cursor: not-allowed; pointer-event: none;"'; ?>>
            Change Password
        </button>
      </form>
      <button 
