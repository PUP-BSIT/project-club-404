...
$stmt->bind_result($post_id, $db_user_id, $content, $created_at, $db_shared_post_id, $location, $file_path, $media_type);
...
while ($stmt->fetch()) {
    $posts[] = [
        ...
        'shared_post_id' => $db_shared_post_id,
        'location' => $location,
